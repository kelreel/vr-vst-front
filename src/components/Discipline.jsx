...
export default function Discipline() {
  return (
    <div className="bg-white m-3 mt-20 max-w-screen-2lg justify-self-center self-center overflow-hidden shadow sm:rounded-lg">
      ...
      <div className="bg-white px-4 py-3 flex items-center justify-between border-t border-gray-200 sm:px-6">
        ...
        <div className="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
          <div>
            <p className="ml-10 mr-10 text-sm text-gray-700"></p>
          </div>
          <div>
            <nav
              className="relative z-0 inline-flex shadow-sm -space-x-px ml-2"
